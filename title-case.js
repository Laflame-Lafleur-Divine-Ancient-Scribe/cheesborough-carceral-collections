(() => {
  const pageNotes = {
    ...
    "DIGITAL-PHOTOGRAPHY-COLLECTIONS.html": "A photograph can show a building, a uniform, a work detail, or a carefully staged moment. It cannot explain itself. Study who made the image, who commissioned it, what falls outside the frame, and how the picture changes when compared with records of custody, labor, education, or violence.",
    ...
    "FORTUNE-FERGUSON-RESEARCH.html": "A prison record can reduce a person to a name, date, and disposition. The Ferguson materials ask what is lost in that compression, and what becomes visible when the individual record is placed beside Florida's racialized history of capital punishment.",
    ...
    "PHOTOGRAPHY-STATES.html": "Place changes the meaning of a record. A state index lets researchers compare jurisdiction, facility design, local policy, and public memory without assuming that one state's history stands for another's. Use the map to find patterns, then investigate the exceptions.",
