...
(() => {
  ...
  function watch() {
    ...
    const player = !film.embed ? '<div class="source-poster">Video source unavailable</div>' : film.embeddable === false ? '<div class="source-poster"><strong>This publisher does not permit embedded playback.</strong><span>Use Watch on YouTube to open the original video.</span></div>' : `<iframe src="https://www.youtube-nocookie.com/embed/${encodeURIComponent(film.embed)}?rel=0" title="${esc(film.title)}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
