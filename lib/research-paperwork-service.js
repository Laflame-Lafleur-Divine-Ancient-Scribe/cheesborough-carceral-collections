...
const ROTATION_BANK = [
  ...
  {
    id: 'rot-diddy-combs-indictment',
    type: 'FBI Vault',
    category: 'sex-trafficking',
    title: 'United States v. Sean "Diddy" Combs — Unsealed Federal Indictment & FBI File',
    docket: '24 Cr. 542',
    ...
    pages: 14,
    bytes: 348160,
    sourceLabel: 'U.S. Department of Justice & FBI NY Field Office',
    sourceUrl: 'https://www.justice.gov/usao-sdny',
    file: '03_Research/IndictmentPaperwork/Sex-Trafficking/combs.pdf',
    directPdf: '03_Research/IndictmentPaperwork/Sex-Trafficking/combs.pdf',
    summary: 'Federal grand jury indictment and joint FBI task force filing charging Sean Combs with racketeering conspiracy, sex trafficking by force, fraud, or coercion, and interstate transportation for prostitution.',
    receiptQuote: '“Combs used the business and employees of the Combs Enterprise to facilitate sex trafficking and racketeering, using violence, threats, narcotics, and coercion.”',
    tags: ['Trending 2025-2026', 'Federal Indictment', 'SDNY', 'FBI Joint Task Force', 'Racketeering'],
    classification: 'UNSEALED FEDERAL RACKETEERING INDICTMENT'
  },
  {
