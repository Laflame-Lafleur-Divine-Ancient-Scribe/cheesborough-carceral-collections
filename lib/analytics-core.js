...
function pagePath(value) {
  ...
  if (/^\/(api|OWNER|LOGIN|JOIN|PROFILE|RECOVER|DEVELOPER|STUDIO|RESET|VERIFY|ANALYTICS-PRIVACY|INSIDE-ASSISTANCE|HELP-FINDER|ASSISTANCE-GUIDE|ASSISTANCE-TEMPLATES|RELEASE-PLANNER|FACILITY-GUIDE)(?:[/.?-]|$)/i.test(decoded) || /\.(css|js|json|png|jpe?g|gif|svg|webp|woff2?|ttf|ico|pdf|mp[34]|wav|ogg|fbx|glb|gltf|txt|csv|xml|md|zip)$/i.test(decoded)) return null;
